...
const ModalForm = (props) => {
	...
	const classes = `absolute w-screen h-screen bg-black bg-opacity-10 backdrop-blur-sm ${props.className}`;
	return (
			...
			<Card className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
				...
				<div className="bg-slate-300 ">
					...
					<div className="flex pb-4 justify-evenly">
						...
						<Button className="w-20 h-12 bg-green-200 rounded">Add</Button>
					</div>
				</div>
			</Card>
		</form>
